...
from Fubuki import HELPABLE, app
from Fubuki.utils.database import get_lang, is_commanddelete_on
from Fubuki.utils.decorators.language import LanguageStart
from Fubuki.utils.inline.help import private_help_panel
from Fubuki.utils.premium import back_btn, close_btn, custom_btn, nav_btn
...
@app.on_callback_query(filters.regex(r"settings_?back_helper") & ~BANNED_USERS)
