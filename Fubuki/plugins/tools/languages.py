...
from Fubuki.utils.database import get_lang, set_lang
from Fubuki.utils.decorators import ActualAdminCB, language, languageCB
from Fubuki.utils.premium import back_btn, close_btn, custom_btn
...
def lanuages_keyboard(_):
    ...
    keyboard.row(
        ...
        close_btn(_["CLOSE_BUTTON"], callback_data="close"),
    )
    return keyboard
