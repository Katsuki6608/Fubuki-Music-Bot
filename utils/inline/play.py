...
from Fubuki.utils.formatters import time_to_seconds
from Fubuki.utils.premium import (
    back_btn,
    close_btn,
    loop_btn,
    music_btn,
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            music_btn(
                _["P_B_1"],
                f"FubukiPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            video_btn(
                _["P_B_2"],
                f"FubukiPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            close_btn(
